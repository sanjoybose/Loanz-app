...
var refreshMultiField = function () {
    var fixedEvent = 0;
    ...
    function keypress(e) {
        ...
        if ((e.keyCode == 8 && sel[1] == 0) || (e.keyCode == 37 && sel[1] == 0))
            setCaret($(this).prevAll('input:not(:hidden)')[0], 100);
            ...
            setCaret($(this).nextAll('input:not(:hidden)')[0], 0);
            ...
            setCaret($(this).nextAll('input:not(:hidden)')[0], 100);
