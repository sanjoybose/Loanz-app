function initCharts() {
    chart1 = new Highcharts.Chart({
        ...
        title: {
            text: 'By Credit Grade',
            align: 'left',
            floating: false,
            useHTML: true,
            x: 50
        },
        colors: Highcharts.map(['#76a943', '#6491a3'], function (color) {
            return {
        ...
        series: [{
            name: 'Adj. Rate Annualized Return',
            data: [5, 7, 10, 10, 11, 12, 11]

        }, {
            name: 'Average Interest Rate',
            data: [7, 11, 15, 17, 21, 27, 25]
    ...
    chart2 = new Highcharts.Chart({
        ...
        series: [{
            name: 'Adj. Rate Annualized Return',
            data: [7, 8, 8, 10, 9, 10, 11]

        }, {
            name: 'Average Interest Rate',
            data: [13, 13, 14, 15, 16, 17, 18]
    ...
    chart3 = new Highcharts.Chart({
        ...
        series: [{
            name: 'Loan Demand',
            data: [0, 0, 1000, 5000, 12000, 29000]
    ...
    chart4 = new Highcharts.Chart({
        ...
        colors: Highcharts.map(['#2b6400'], function (color) {
            return {
                //radialGradient: { cx: 0.5, cy: 0.3, r: 0.7 },
                linearGradient: { x1: 0, x2: 1, y1: 1, y2: 1 },
                stops: [
        ...
        title: {
            text: 'Average stated interest rate'
        },
        xAxis: {
            type: 'datetime',
    ...
    for (var i = 0; i < 1000; i++) {
        data1[0].data.push([Random(10, 1000), Random(10, 1000)]);
    }
...
var data = [{
    ...
    type: 'column',
    data: [
        { name: 'Toyota', y: 4, drilldown: 'abc' },
        { name: 'Opel', y: 2, drilldown: 'def' },
        ['Volkswagen', 2]
    ]
}, {
    id: 'abc',
...
function myViewModel() {
    this.pieData = ko.observableArray(data);
    this.scatterData = ko.observableArray(data1);
};
